                    ...
                    <div className="form-group">
                        ...
                        <select name="category" className="form-control" onChange={handleChange}>
                            {props.categories.map((term) => {
                                if(props.book.category !== undefined && props.book.category.localeCompare(term.name))
                                    return <option selected={props.book.category.name} value={term.valueOf()}>{term.name}</option>
